# How to Configure HTTPS for Is'alni AWS private deployment
...
**Requirements**
- Successful deployment of Amazon Linux 2023 EC2 instance with Docker container running Is'alni
...
## Step 7: Create simple http proxy configuration for Is'alni 
These instructions are for CLI configuration and assume you are logged in to EC2 instance as the ec2-user.
...
3. Navigate to http://FQDN in a browser and you should be proxied to the Is'alni web UI.
...
2. Navigate to https://FQDN in a browser and you should be proxied to the Is'alni web UI.
