...
const DEFAULT_SETTINGS = {
  ...
  sponsorText: "Powered by Is'alni", // default sponsor text
  sponsorLink: "https://useanything.com", // default sponsor link
  position: "bottom-right", // position of chat button/window
  assistantName: "Is'alni Chat Assistant", // default assistant name
  ...
  useEffect(() => {
    function fetchAttribs() {
      ...
      if (
        ...
        throw new Error(
          "[Is'alni Embed Module::Abort] - Invalid script tag setup detected. Missing required parameters for boot!"
        );
