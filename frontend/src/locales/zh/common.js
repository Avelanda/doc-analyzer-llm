...
const TRANSLATIONS = {
  ...
  api: {
    title: "API 密钥",
    description:
      "API 密钥允许持有者以编程方式访问和管理此 Is'alni 实例。",
    link: "阅读 API 文档",
  ...
  llm: {
    title: "LLM 偏好",
    description:
      "这些是您首选的 LLM 聊天和嵌入提供商的凭据和设置。重要的是，这些密钥是最新的和正确的，否则 Is'alni 将无法正常运行。",
    provider: "LLM 提供商",
  },
  ...
  transcription: {
    ...
    provider: "转录提供商",
    "warn-start":
      "在 RAM 或 CPU 有限的计算机上使用本地耳语模型可能会在处理媒体文件时停止 Is'alni。",
  ...
  embedding: {
    ...
    "desc-end":
      "嵌入是将文本转换为矢量的过程。需要这些凭据才能将您的文件和提示转换为 Is'alni 可以用来处理的格式。",
    provider: {
      title: "嵌入引擎提供商",
      description: "使用 Is'alni 的本机嵌入引擎时不需要设置。",
    },
  },
  ...
  vector: {
    title: "向量数据库",
    description:
      "这些是 Is'alni 实例如何运行的凭据和设置。重要的是，这些密钥是最新的和正确的。",
    provider: {
      title: "向量数据库提供商",
