const TRANSLATIONS = {
  ...
  appearance: {
    ...
    message: {
      ...
      user: "utilisateur",
      message: "message",
      assistant: "Assistant de chat Is'alni",
  ...
  api: {
    title: "Clés API",
    description:
      "Les clés API permettent au titulaire d'accéder et de gérer de manière programmatique cette instance Is'alni.",
  ...
  llm: {
    ...
    description:
      "Voici les identifiants et les paramètres de votre fournisseur LLM de chat et d'intégration préféré. Il est important que ces clés soient actuelles et correctes, sinon Is'alni ne fonctionnera pas correctement.",
  ...
  transcription: {
    ...
    "warn-start":
      "L'utilisation du modèle local whisper sur des machines avec une RAM ou un CPU limités peut bloquer Is'alni lors du traitement des fichiers multimédias.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "L'intégration est le processus de transformation du texte en vecteurs. Ces identifiants sont nécessaires pour transformer vos fichiers et invites en un format que Is'alni peut utiliser pour traiter.",
    provider: {
      title: "Fournisseur d'intégration",
      description:
        "Aucune configuration n'est nécessaire lors de l'utilisation du moteur d'intégration natif de Is'alni.",
    },
  },
  ...
  vector: {
    ...
    description:
      "Voici les identifiants et les paramètres de fonctionnement de votre instance Is'alni. Il est important que ces clés soient actuelles et correctes.",
    provider: {
  ...
  multi: {
    ...
    password: {
      ...
      description:
        "Protégez votre instance Is'alni avec un mot de passe. Si vous oubliez ce mot de passe, il n'y a pas de méthode de récupération, donc assurez-vous de le sauvegarder.",
    },
    instance: {
  ...
  privacy: {
    ...
    description:
      "Voici votre configuration pour la gestion des données et des fournisseurs tiers connectés avec Is'alni.",
    llm: "Sélection LLM",
