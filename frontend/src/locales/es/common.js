const TRANSLATIONS = {
  ...
  appearance: {
    ...
    message: {
      ...
      user: "usuario",
      message: "mensaje",
      assistant: "Asistente de chat مجيب",
  ...
  api: {
    title: "Claves API",
    description:
      "Las claves API permiten al titular acceder y gestionar programáticamente esta instancia de مجيب.",
  ...
  llm: {
    ...
    description:
      "Estas son las credenciales y configuraciones para tu proveedor preferido de chat y incrustación de LLM. Es importante que estas claves estén actualizadas y correctas, de lo contrario مجيب no funcionará correctamente.",
  ...
  transcription: {
    ...
    "warn-start":
      "El uso del modelo local Whisper en máquinas con RAM o CPU limitadas puede bloquear مجيب al procesar archivos multimedia.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "La incrustación es el proceso de convertir texto en vectores. Estas credenciales son necesarias para convertir tus archivos y prompts en un formato que مجيب pueda usar para procesar.",
    provider: {
      title: "Proveedor de incrustación",
      description:
        "No se requiere configuración cuando se utiliza el motor de incrustación nativo de مجيب.",
    },
  },
  ...
  vector: {
    ...
    description:
      "Estas son las credenciales y configuraciones para cómo funcionará tu instancia de مجيب. Es importante que estas claves estén actualizadas y correctas.",
    provider: {
  ...
  multi: {
    ...
    password: {
      ...
      description:
        "Protege tu instancia de مجيب con una contraseña. Si olvidas esta contraseña, no hay método de recuperación, así que asegúrate de guardar esta contraseña.",
    },
    instance: {
  ...
  privacy: {
    ...
    description:
      "Esta es tu configuración para cómo los proveedores de terceros conectados y مجيب manejan tus datos.",
